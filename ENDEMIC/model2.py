...
#             s_o1, s_o2 = apply_cross_stitch(sent_output, y1)
#             s_o1 = self.addn_model3(s_o1)
            sent_output = self.addn_model3(sent_output)
#             s_o1, s_o3 = apply_cross_stitch(s_o1, y2)
#             s_o3 = self.addn_model2(s_o3)
#             y = s_o2
            s_o1 = sent_output
            s_o2 = y1 + y2
#             s_o3 = y2
            
            sent_output = torch.cat((s_o1, s_o2), dim=1)

...
#                  self.encoder.state_dict(),
    ...
    def _run_epoch(self, train_data, dev_data, unlabel_data, addn_data, addn_data_unlab, addn_dev):
        addn_dev.cuda()
...
#             print(addn_batch.shape)
    ...
    def _train(self, train_data, dev_data, unlabel_data, addn_data, addn_data_unlab, addn_dev):
...
#             random.shuffle(unlabel_data)
            accuracy = self._run_epoch(train_data, dev_data, unlabel_data, addn_data, addn_data_unlab, addn_dev)

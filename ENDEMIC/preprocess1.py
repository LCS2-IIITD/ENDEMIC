...
#     print('Removed unlabelled data: %d' % len(unlab_r))
    ...
    # Addn Dataset
    print('Prepearing addn data...')
    addn_data_tweets = np.load(args.addndata + "/train/tweet_features_train.npy")
    addn_data_users = np.load(args.addndata + "/train/user_features_train.npy")
...
#         print("\t", i)
    ...
    addn_data_tweets_t = np.load(args.addndata + "/test/tweet_features_test.npy")
    addn_data_users_t = np.load(args.addndata + "/test/user_features_test.npy")
